...
const expenseTypes = [
	...
	{ value: 'PORT_HANDLING_FEE', label: 'Port Handling Fee' },
	{ value: 'TOWING', label: 'Towing' },
	{ value: 'CUSTOMS', label: 'Customs' },
	{ value: 'CUSTOM_FEE', label: 'Custom Fee' },
	{ value: 'RELIST_FEE', label: 'Relist Fee' },
	{ value: 'COO_FEE', label: 'COO Fee' },
	{ value: 'ATESTATION_FEE', label: 'Atestation Fee' },
	{ value: 'CLEARANCE_FEE', label: 'Clearance Fee' },
	{ value: 'HYBRID_FEE', label: 'Hybrid Fee' },
	{ value: 'STORAGE_FEE', label: 'Storage Fee' },
	{ value: 'AUCTION_STORAGE_FEE', label: 'Auction Storage Fee' },
    { value: 'HANDLING_FEE', label: 'Handling Fee' },
	{ value: 'TITLE_HANDLING_FEE', label: 'Title Handling Fee' },
