...
export async function GET(
  ...
  try {
    ...
    // ⚡ Bolt: Replace chained .filter().reduce() with single-pass for...of loops to improve O(N) performance
    ...
    // ⚡ Bolt: Replace chained .filter().reduce() and .filter().length with single-pass for...of loops
